...
using It.Uniba.Di.Cdg.SocialTfs.ServiceLibrary.StackOverflow;
using It.Uniba.Di.Cdg.SocialTfs.ServiceLibrary.Coderwall;
using It.Uniba.Di.Cdg.SocialTfs.ServiceLibrary.Ohloh;
    ...
    public class ServiceFactory
    {
        ...
        public static IService getServiceOauth(String serviceName, String host, String consumerKey, String consumerSecret, String accessToken, String accessSecret)
        {
            ...
            switch (serviceName)
            {
                ...
                case "LinkedIn":
                    return new LinkedInService(host, consumerKey, consumerSecret, accessToken, accessSecret);
                case "StackOverflow":
                    return new StackOverflowService(host, consumerKey, consumerSecret, accessToken);
                case "Facebook":
        ...
        public static IService getService(String serviceName, String username, String password, String domain, String host)
        {
            ...
            switch (serviceName)
            {
                ...
                case "Coderwall":
                    return new CoderwallService(username, host);
                case "Ohloh":
                    return new OhlohService(username, host);
                default:
                    throw new Exception("\"" + serviceName + "\" service does not exist");
            }
        }
        ...
        public static IService getService(String serviceName)
        {
            ...
            switch (serviceName)
            {
                ...
                case "Ohloh":
                    return new OhlohService();
                case "Coderwall":
                    return new CoderwallService();
                default:
                    throw new Exception("\"" + serviceName + "\" service does not exist");
            }
        }
